<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="公文分类" prop="gongwenfenlei">
					<el-input v-model="ruleForm.gongwenfenlei" placeholder="公文分类" clearable  :readonly="ro.gongwenfenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="公文分类" prop="gongwenfenlei">
					<el-input v-model="ruleForm.gongwenfenlei" placeholder="公文分类" readonly></el-input>
				</el-form-item>
			</template>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `gongwenfenlei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.gongwenfenleiCrossAddOrUpdateFlag = false;
						 this.parent.search();
